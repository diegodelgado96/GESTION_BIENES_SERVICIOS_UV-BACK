...
-- Schema SI_TESIS
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `SI_TESIS` ;
-- -----------------------------------------------------
-- Schema SI_TESIS
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `SI_TESIS` ;
...
CREATE TABLE IF NOT EXISTS `SI_TESIS`.`Login` (
  ...
  INDEX `fk_Login_Usuarios_idx` (`Usuarios_idUsuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SI_TESIS`.`Proveedores` (
  ...
  UNIQUE INDEX `idProveedores_UNIQUE` (`idProveedor` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `SI_TESIS`.`Reporte_Infraestructura` (
  ...
  UNIQUE INDEX `idResporte_UNIQUE` (`idReporte` ASC) VISIBLE,
  UNIQUE INDEX `token_UNIQUE` (`token` ASC) VISIBLE,
  INDEX `fk_Reporte_Infraestructura_Proveedores1_idx` (`Proveedores_idProveedor` ASC) VISIBLE,
  INDEX `fk_Reporte_Infraestructura_Usuarios1_idx` (`Usuarios_idUsuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SI_TESIS`.`Acciones` (
  ...
  `Reporte_Infraestructura_idReporte` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idAccion`),
  UNIQUE INDEX `idAcciones_Reporte_UNIQUE` (`idAccion` ASC) VISIBLE,
  INDEX `fk_Acciones_Reporte_Infraestructura1_idx` (`Reporte_Infraestructura_idReporte` ASC) VISIBLE,
  CONSTRAINT `fk_Acciones_Reporte_Infraestructura1`
    FOREIGN KEY (`Reporte_Infraestructura_idReporte`)
    REFERENCES `SI_TESIS`.`Reporte_Infraestructura` (`idReporte`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `SI_TESIS`.`Solicitud_Bienes_Servicios` (
  ...
  INDEX `fk_Solicitud_Bienes_Servicios_Proveedores1_idx` (`Proveedores_idProveedor` ASC) VISIBLE,
  INDEX `fk_Solicitud_Bienes_Servicios_Acciones1_idx` (`Acciones_idAccion` ASC) VISIBLE,
  INDEX `fk_Solicitud_Bienes_Servicios_Usuarios1_idx` (`Usuarios_idUsuario` ASC) VISIBLE,
